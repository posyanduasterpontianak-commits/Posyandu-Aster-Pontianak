...
function getSupabaseConfig(): SupabaseConfig {
  // Storage API membutuhkan JWT service_role key (format: eyJ...)
  // Prefer SUPABASE_SERVICE_ROLE_JWT jika tersedia (digunakan untuk Storage Admin API)
  const secretKey =
  ...
  return {
    ...
    secretKey: requiredEnv("SUPABASE_SERVICE_ROLE_JWT atau SUPABASE_SECRET_KEY", secretKey),
  };
}
